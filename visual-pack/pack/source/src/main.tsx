...
import "./index.css";
import "./styles/focus-champion.css";
import "./styles/header-champion-fix.css";
...
const logStartupEnforcement = (
  startupEnforcement: ReturnType<typeof enforce>,
) => {
  if (!startupEnforcement.success) {
    console.warn(
      "[STARTUP] Governance enforcement detected issues:",
      startupEnforcement.errors,
    );
