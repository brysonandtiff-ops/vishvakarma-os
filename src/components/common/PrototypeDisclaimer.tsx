...
export function PrototypeDisclaimerBadge() {
  return (
    <div
      className="pointer-events-none fixed bottom-16 left-3 z-50 max-w-[min(100vw-1.5rem,20rem)] text-[11px] tracking-wide text-primary/60 tablet:hidden lg:bottom-3"
