...
Generated at: 2026-06-15T17:45:42.643Z
Commit: `7df67e9e7e7e8ec74bec939c678e03efb8311c1b`
...
| Metric | Value |
|--------|-------|
| Spatial index (300 lookups) | 16.12 ms |
| Linear scan (300 lookups) | 45.33 ms |
...
| 1 | p1-spatial-index | Spatial index hit-test parity + mock benchmark | **PASS** | indexed=16.12ms linear=45.33ms parity=w200 |
