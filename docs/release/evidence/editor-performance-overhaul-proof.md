...
Generated at: 2026-08-06T18:07:24.352Z
Commit: `8103ff0b646f61c10f439a2cc576d7da6845444d`
...
| Metric | Value |
|--------|-------|
| Spatial index (300 lookups) | 5.43 ms |
| Linear scan (300 lookups) | 7.81 ms |
...
| 1 | p1-spatial-index | Spatial index hit-test parity + mock benchmark | **PASS** | indexed=5.43ms linear=7.81ms parity=w200 |
