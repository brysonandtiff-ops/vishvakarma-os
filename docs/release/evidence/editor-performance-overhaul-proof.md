...
Generated at: 2026-06-19T06:35:17.577Z
Commit: `6390a1154b3e7f9f7e16fdc44bed0cd8837cdfde`
...
| Metric | Value |
|--------|-------|
| Spatial index (300 lookups) | 2.40 ms |
| Linear scan (300 lookups) | 5.12 ms |
...
| 1 | p1-spatial-index | Spatial index hit-test parity + mock benchmark | **PASS** | indexed=2.40ms linear=5.12ms parity=w200 |
