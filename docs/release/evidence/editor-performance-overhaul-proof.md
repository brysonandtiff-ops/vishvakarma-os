...
Generated at: 2026-06-15T09:28:29.967Z
Commit: `4d0606f278fb593abe72eb5b6e130a33f2f3b9ee`
...
| Metric | Value |
|--------|-------|
| Spatial index (300 lookups) | 2.53 ms |
| Linear scan (300 lookups) | 4.32 ms |
...
| 1 | p1-spatial-index | Spatial index hit-test parity + mock benchmark | **PASS** | indexed=2.53ms linear=4.32ms parity=w200 |
