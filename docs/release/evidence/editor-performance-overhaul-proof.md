...
Generated at: 2026-06-22T22:09:43.148Z
Commit: `421e42907b286c8ced62dfbfdca17cf9afa47f01`
...
| Metric | Value |
|--------|-------|
| Spatial index (300 lookups) | 3.59 ms |
| Linear scan (300 lookups) | 21.76 ms |
...
| 1 | p1-spatial-index | Spatial index hit-test parity + mock benchmark | **PASS** | indexed=3.59ms linear=21.76ms parity=w200 |
