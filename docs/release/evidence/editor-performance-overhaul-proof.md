...
Generated at: 2026-08-08T10:12:29.528Z
Commit: `c893296b49578a0bd8ae7ec0453253d19dde37e3`
...
| Metric | Value |
|--------|-------|
| Spatial index (300 lookups) | 3.65 ms |
| Linear scan (300 lookups) | 5.02 ms |
...
| 1 | p1-spatial-index | Spatial index hit-test parity + mock benchmark | **PASS** | indexed=3.65ms linear=5.02ms parity=w200 |
