...
Generated at: 2026-06-19T06:30:17.347Z
Commit: `491ff3bb7add31c07b7d2ca8486e44d26c634b55`
...
| Metric | Value |
|--------|-------|
| Spatial index (300 lookups) | 6.35 ms |
| Linear scan (300 lookups) | 17.83 ms |
...
| 1 | p1-spatial-index | Spatial index hit-test parity + mock benchmark | **PASS** | indexed=6.35ms linear=17.83ms parity=w200 |
