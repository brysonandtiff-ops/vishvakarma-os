# Deployment Checklist - VISHVAKARMA.OS

Run: 2026-07-21 20:01:24 · commit `d89f37cb4`

- [ ] Champion pipeline green (0%)
- [ ] Evidence pack reviewed (`docs\release\evidence\20260721-200124`)
- [ ] Release notes reviewed (`release-notes.md`)
- [ ] Git tag pushed (`git push --tags`)
- [ ] Deploy `dist/` to production host
- [ ] Smoke-test https://vishvakarma-os.app on iPad Safari
