...
| Property | Value |
|----------|-------|
| Submit Endpoint | `POST https://app-9nam5bayv401-api-k93RvqRrRZba.gateway.appmedo.com/v1/videos/omni-video` |
| Query Endpoint | `GET https://app-9nam5bayv401-api-pLVzAEz1ZQOL.gateway.appmedo.com/v1/videos/omni-video/{task_id}` |
