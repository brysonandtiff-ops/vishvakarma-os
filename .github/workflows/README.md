...
- Run `pnpm run lint`, `pnpm run hardening:gates`, `pnpm run test`, `pnpm run build`, `pnpm run perf:gates`, and the relevant Playwright/QE commands on a developer machine before pushing or deploying.
