#!/usr/bin/env node
/** Build e2e preview with local editor access, start preview, capture sell closeout UI screenshots, then exit. */
...
try {
  ...
  run('pnpm exec playwright test e2e/sell-closeout-pack.spec.ts --project=screenshot-pack');
} finally {
