import { n as __export } from "./chunk-XkmBru0b.js";

//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/Types.js
...
//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/utils.js
/**
...
function attachCallSiteToError(err, callSiteStack) {
	if (!err || !err.stack || !callSiteStack) return;
	...
	err.stack = `${existingMarkerIdx >= 0 ? err.stack.substring(0, existingMarkerIdx) : err.stack}${CALL_SITE_MARKER}\n${callerFrames}`;
}

//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/net/HttpClient.js
/**
...
//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/net/FetchHttpClient.js
/**
...
//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/crypto/CryptoProvider.js
/**
...
//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/crypto/SubtleCryptoProvider.js
/**
...
//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/platform/PlatformFunctions.js
/**
...
//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/StripeEmitter.js
/**
* @private
...
//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/platform/WebPlatformFunctions.js
/**
...
//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/Decimal.js
/**
...
const Decimal = {
	from(value) {
		...
		if (!Number.isSafeInteger(exponentPart) || exponentPart > MAX_EXPONENT || exponentPart < -MAX_EXPONENT) throw new Error(`Exponent out of range: ${String(match[4])} exceeds safe integer bounds`);
		...
		if (!Number.isSafeInteger(exponent) || exponent > MAX_EXPONENT || exponent < -MAX_EXPONENT) throw new Error(`Computed exponent out of range: ${String(exponent)} exceeds safe integer bounds`);
...
//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/Error.js
...
//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/RequestSender.js
...
var RequestSender = class RequestSender {
	...
	_emitStripeNotice(headers) {
		...
		if (notice) this._stripe._platformFunctions.emitWarning(typeof notice === "string" ? notice : notice[0]);
	}
	/**
	...
	*/
	...
	_makeHeaders({ contentType, contentLength, apiVersion, clientUserAgent, method, userSuppliedHeaders, userSuppliedSettings, stripeAccount, stripeContext, apiMode }) {
		...
		if (methodHasPayload || contentLength) {
			if (!methodHasPayload) this._stripe._platformFunctions.emitWarning(`${method} method had non-zero contentLength but no payload is expected for this verb`);
	...
	_recordRequestMetrics(requestId, requestDurationMs, usage) {
		if (this._stripe.getTelemetryEnabled() && requestId) if (this._stripe._prevRequestMetrics.length > this._maxBufferedRequestMetric) this._stripe._platformFunctions.emitWarning("Request metrics buffer is full, dropping telemetry message.");
		else {
			const m = {
	...
	*/
	_request(method, host, path, data, authenticator, options, usage = [], callback, requestDataProcessor = null) {
		...
		const makeRequest = (apiVersion, headers, numRetries) => {
			...
			authenticator(request).then(() => {
				...
				req.then((res) => {
					...
					if (RequestSender._shouldRetry(null, requestRetries, maxRetries, error)) return retryRequest(makeRequest, apiVersion, headers, requestRetries);
		...
		const prepareAndMakeRequest = (error, data$1) => {
			...
			this._stripe.getClientUserAgent((clientUserAgent) => {
				...
				makeRequest(apiVersion, this._makeHeaders({
					...
					contentLength: this._getContentLength(data$1),
					apiVersion,
					clientUserAgent,
					method,
...
//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/V2Coercion.js
/**
...
//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/autoPagination.js
...
function makeAutoPagingEach(asyncIteratorNext) {
	return function autoPagingEach() {
		const callSiteStack = (/* @__PURE__ */ new Error()).stack;
		const args = [].slice.call(arguments);
		const onItem = getItemCallback(args);
		const onDone = getDoneCallback(args);
		if (args.length > 2) throw Error(`autoPagingEach takes up to two arguments; received ${args}`);
		const autoPagePromise = wrapAsyncIteratorWithCallback(asyncIteratorNext, onItem).catch((err) => {
...
//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/StripeResource.js
/**
...
var StripeResource = class {
	...
	_makeRequest(method, path, params, options, spec) {
		const requestMethod = method.toUpperCase();
		const data = (spec?.encode || ((data$1) => data$1))(params ? { ...params } : {});
		const processed = processOptions(options);
...
//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/StripeContext.js
/**
...
//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/Webhooks.js
function createWebhooks(platformFunctions) {
	const Webhook = {
		...
		generateTestHeaderString: function(opts) {
			...
			const signature$1 = preparedOpts.signature || preparedOpts.cryptoProvider.computeHMACSignature(preparedOpts.payloadString, preparedOpts.secret);
			return preparedOpts.generateHeaderString(signature$1);
		},
		generateTestHeaderStringAsync: async function(opts) {
			const preparedOpts = prepareOptions(opts);
			const signature$1 = preparedOpts.signature || await preparedOpts.cryptoProvider.computeHMACSignatureAsync(preparedOpts.payloadString, preparedOpts.secret);
			return preparedOpts.generateHeaderString(signature$1);
		}
	};
	const signature = {
	...
	*/
	...
	function prepareOptions(opts) {
		...
		const generateHeaderString = (signature$1) => {
			return `t=${timestamp},${scheme}=${signature$1}`;
		};
		return {
			...opts,
			timestamp,
...
//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/apiVersion.js
const ApiVersion = "2026-05-27.dahlia";

//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/ResourceNamespace.js
...
//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/resources/V2/Core/AccountLinks.js
...
//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/resources/V2/Core/AccountTokens.js
...
//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/resources/FinancialConnections/Accounts.js
var AccountResource$2 = class extends StripeResource {
	...
	*/
	listOwners(id, params, options) {
		return this._makeRequest("GET", `/v1/financial_connections/accounts/${encodeURIComponent(id)}/owners`, params, options, { methodType: "list" });
	}
};

//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/resources/V2/Core/Accounts/Persons.js
var PersonResource = class extends StripeResource {
	...
	*/
	retrieve(accountId, id, params, options) {
		return this._makeRequest("GET", `/v2/core/accounts/${encodeURIComponent(accountId)}/persons/${encodeURIComponent(id)}`, params, options, { responseSchema: {
			kind: "object",
			fields: { relationship: {
				kind: "object",
				fields: { percent_ownership: { kind: "decimal_string" } }
...
//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/resources/V2/Core/Accounts/PersonTokens.js
var PersonTokenResource = class extends StripeResource {
	...
	*/
	create(accountId, params, options) {
		return this._makeRequest("POST", `/v2/core/accounts/${encodeURIComponent(accountId)}/person_tokens`, params, options, { requestSchema: {
			kind: "object",
			fields: { relationship: {
				kind: "object",
				fields: { percent_ownership: { kind: "decimal_string" } }
...
//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/resources/V2/Core/Accounts.js
var AccountResource$1 = class extends StripeResource {
	...
	*/
	retrieve(id, params, options) {
		return this._makeRequest("GET", `/v2/core/accounts/${encodeURIComponent(id)}`, params, options, { responseSchema: {
			kind: "object",
			fields: { identity: {
				kind: "object",
				fields: { individual: {
	...
	*/
	close(id, params, options) {
		return this._makeRequest("POST", `/v2/core/accounts/${encodeURIComponent(id)}/close`, params, options, { responseSchema: {
			kind: "object",
			fields: { identity: {
				kind: "object",
				fields: { individual: {
...
//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/resources/Entitlements/ActiveEntitlements.js
...
//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/resources/Billing/Alerts.js
...
//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/resources/Tax/Associations.js
...
//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/resources/Issuing/Authorizations.js
var AuthorizationResource$1 = class extends StripeResource {
	...
	*/
	retrieve(id, params, options) {
		return this._makeRequest("GET", `/v1/issuing/authorizations/${encodeURIComponent(id)}`, params, options, { responseSchema: {
			kind: "object",
			fields: {
				fleet: {
					kind: "nullable",
	...
	*/
	update(id, params, options) {
		return this._makeRequest("POST", `/v1/issuing/authorizations/${encodeURIComponent(id)}`, params, options, { responseSchema: {
			kind: "object",
			fields: {
				fleet: {
					kind: "nullable",
	...
	*/
	approve(id, params, options) {
		return this._makeRequest("POST", `/v1/issuing/authorizations/${encodeURIComponent(id)}/approve`, params, options, { responseSchema: {
			kind: "object",
			fields: {
				fleet: {
					kind: "nullable",
	...
	*/
	decline(id, params, options) {
		return this._makeRequest("POST", `/v1/issuing/authorizations/${encodeURIComponent(id)}/decline`, params, options, { responseSchema: {
			kind: "object",
			fields: {
				fleet: {
					kind: "nullable",
...
//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/resources/TestHelpers/Issuing/Authorizations.js
var AuthorizationResource = class extends StripeResource {
	...
	*/
	expire(id, params, options) {
		return this._makeRequest("POST", `/v1/test_helpers/issuing/authorizations/${encodeURIComponent(id)}/expire`, params, options, { responseSchema: {
			kind: "object",
			fields: {
				fleet: {
					kind: "nullable",
	...
	*/
	respond(id, params, options) {
		return this._makeRequest("POST", `/v1/test_helpers/issuing/authorizations/${encodeURIComponent(id)}/fraud_challenges/respond`, params, options, { responseSchema: {
			kind: "object",
			fields: {
				fleet: {
					kind: "nullable",
	...
	*/
	increment(id, params, options) {
		return this._makeRequest("POST", `/v1/test_helpers/issuing/authorizations/${encodeURIComponent(id)}/increment`, params, options, { responseSchema: {
			kind: "object",
			fields: {
				fleet: {
					kind: "nullable",
	...
	*/
	reverse(id, params, options) {
		return this._makeRequest("POST", `/v1/test_helpers/issuing/authorizations/${encodeURIComponent(id)}/reverse`, params, options, { responseSchema: {
			kind: "object",
			fields: {
				fleet: {
					kind: "nullable",
...
//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/resources/Tax/Calculations.js
var CalculationResource = class extends StripeResource {
	...
	*/
	listLineItems(id, params, options) {
		return this._makeRequest("GET", `/v1/tax/calculations/${encodeURIComponent(id)}/line_items`, params, options, { methodType: "list" });
	}
};

//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/resources/Issuing/Cardholders.js
...
//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/resources/Issuing/Cards.js
...
//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/resources/TestHelpers/Issuing/Cards.js
...
//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/resources/BillingPortal/Configurations.js
...
//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/resources/Terminal/Configurations.js
...
//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/resources/TestHelpers/ConfirmationTokens.js
...
//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/resources/Terminal/ConnectionTokens.js
...
//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/resources/Billing/CreditBalanceSummary.js
...
//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/resources/Billing/CreditBalanceTransactions.js
...
//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/resources/Billing/CreditGrants.js
...
//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/resources/Treasury/CreditReversals.js
...
//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/resources/TestHelpers/Customers.js
...
//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/resources/Treasury/DebitReversals.js
...
//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/resources/Issuing/Disputes.js
...
//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/resources/Radar/EarlyFraudWarnings.js
...
//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/resources/V2/Core/EventDestinations.js
...
//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/resources/V2/Core/Events.js
var EventResource$1 = class extends StripeResource {
	...
	*/
	retrieve(id, params, options) {
		...
		return this._makeRequest("GET", `/v2/core/events/${encodeURIComponent(id)}`, params, options, { transformResponseData });
	}
	/**
	* @private
	*
...
//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/resources/Entitlements/Features.js
...
//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/resources/Treasury/FinancialAccounts.js
...
//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/resources/V2/Commerce/ProductCatalog/Imports.js
var ImportResource = class extends StripeResource {
	...
	*/
	create(params, options) {
		return this._makeRequest("POST", "/v2/commerce/product_catalog/imports", params, options, { responseSchema: {
			kind: "object",
			fields: { status_details: {
				kind: "object",
				fields: {
	...
	*/
	retrieve(id, params, options) {
		return this._makeRequest("GET", `/v2/commerce/product_catalog/imports/${encodeURIComponent(id)}`, params, options, { responseSchema: {
			kind: "object",
			fields: { status_details: {
				kind: "object",
				fields: {
...
//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/resources/TestHelpers/Treasury/InboundTransfers.js
...
//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/resources/Treasury/InboundTransfers.js
...
//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/resources/Terminal/Locations.js
...
//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/resources/Billing/MeterEventAdjustments.js
...
//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/resources/V2/Billing/MeterEventAdjustments.js
...
//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/resources/V2/Billing/MeterEventSession.js
...
//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/resources/V2/Billing/MeterEventStream.js
...
//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/resources/Billing/MeterEvents.js
...
//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/resources/V2/Billing/MeterEvents.js
...
//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/resources/Billing/Meters.js
var MeterResource = class extends StripeResource {
	...
	*/
	listEventSummaries(id, params, options) {
		return this._makeRequest("GET", `/v1/billing/meters/${encodeURIComponent(id)}/event_summaries`, params, options, { methodType: "list" });
	}
};

//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/resources/Terminal/OnboardingLinks.js
...
//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/resources/Climate/Orders.js
var OrderResource = class extends StripeResource {
	...
	*/
	retrieve(id, params, options) {
		return this._makeRequest("GET", `/v1/climate/orders/${encodeURIComponent(id)}`, params, options, { responseSchema: {
			kind: "object",
			fields: { metric_tons: { kind: "decimal_string" } }
		} });
	}
	...
	*/
	update(id, params, options) {
		return this._makeRequest("POST", `/v1/climate/orders/${encodeURIComponent(id)}`, params, options, { responseSchema: {
			kind: "object",
			fields: { metric_tons: { kind: "decimal_string" } }
		} });
	}
	...
	*/
	cancel(id, params, options) {
		return this._makeRequest("POST", `/v1/climate/orders/${encodeURIComponent(id)}/cancel`, params, options, { responseSchema: {
			kind: "object",
			fields: { metric_tons: { kind: "decimal_string" } }
		} });
	}
...
//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/resources/TestHelpers/Treasury/OutboundPayments.js
...
//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/resources/Treasury/OutboundPayments.js
...
//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/resources/TestHelpers/Treasury/OutboundTransfers.js
...
//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/resources/Treasury/OutboundTransfers.js
...
//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/resources/Radar/PaymentEvaluations.js
...
//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/resources/Issuing/PersonalizationDesigns.js
...
//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/resources/TestHelpers/Issuing/PersonalizationDesigns.js
...
//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/resources/Issuing/PhysicalBundles.js
...
//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/resources/Climate/Products.js
var ProductResource$1 = class extends StripeResource {
	...
	*/
	retrieve(id, params, options) {
		return this._makeRequest("GET", `/v1/climate/products/${encodeURIComponent(id)}`, params, options, { responseSchema: {
			kind: "object",
			fields: { metric_tons_available: { kind: "decimal_string" } }
		} });
	}
...
//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/resources/Terminal/Readers.js
...
//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/resources/TestHelpers/Terminal/Readers.js
...
//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/resources/TestHelpers/Treasury/ReceivedCredits.js
...
//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/resources/Treasury/ReceivedCredits.js
...
//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/resources/TestHelpers/Treasury/ReceivedDebits.js
...
//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/resources/Treasury/ReceivedDebits.js
...
//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/resources/TestHelpers/Refunds.js
...
//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/resources/Tax/Registrations.js
...
//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/resources/Reporting/ReportRuns.js
...
//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/resources/Reporting/ReportTypes.js
...
//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/resources/Forwarding/Requests.js
...
//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/resources/Sigma/ScheduledQueryRuns.js
...
//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/resources/Apps/Secrets.js
...
//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/resources/BillingPortal/Sessions.js
...
//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/resources/Checkout/Sessions.js
var SessionResource$1 = class extends StripeResource {
	...
	*/
	retrieve(id, params, options) {
		return this._makeRequest("GET", `/v1/checkout/sessions/${encodeURIComponent(id)}`, params, options, { responseSchema: {
			kind: "object",
			fields: {
				currency_conversion: {
					kind: "nullable",
	...
	*/
	expire(id, params, options) {
		return this._makeRequest("POST", `/v1/checkout/sessions/${encodeURIComponent(id)}/expire`, params, options, { responseSchema: {
			kind: "object",
			fields: {
				currency_conversion: {
					kind: "nullable",
...
//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/resources/FinancialConnections/Sessions.js
...
//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/resources/Tax/Settings.js
...
//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/resources/Climate/Suppliers.js
...
//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/resources/TestHelpers/TestClocks.js
...
//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/resources/Issuing/Tokens.js
...
//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/resources/Treasury/TransactionEntries.js
var TransactionEntryResource = class extends StripeResource {
	...
	*/
	retrieve(id, params, options) {
		return this._makeRequest("GET", `/v1/treasury/transaction_entries/${encodeURIComponent(id)}`, params, options, { responseSchema: {
			kind: "object",
			fields: { flow_details: {
				kind: "nullable",
				inner: {
...
//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/resources/FinancialConnections/Transactions.js
...
//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/resources/Issuing/Transactions.js
var TransactionResource$3 = class extends StripeResource {
	...
	*/
	retrieve(id, params, options) {
		return this._makeRequest("GET", `/v1/issuing/transactions/${encodeURIComponent(id)}`, params, options, { responseSchema: {
			kind: "object",
			fields: { purchase_details: {
				kind: "nullable",
				inner: {
	...
	*/
	update(id, params, options) {
		return this._makeRequest("POST", `/v1/issuing/transactions/${encodeURIComponent(id)}`, params, options, { responseSchema: {
			kind: "object",
			fields: { purchase_details: {
				kind: "nullable",
				inner: {
...
//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/resources/Tax/Transactions.js
var TransactionResource$2 = class extends StripeResource {
	...
	*/
	listLineItems(id, params, options) {
		return this._makeRequest("GET", `/v1/tax/transactions/${encodeURIComponent(id)}/line_items`, params, options, { methodType: "list" });
	}
};

//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/resources/TestHelpers/Issuing/Transactions.js
var TransactionResource$1 = class extends StripeResource {
	/**
	* Refund a test-mode Transaction.
	*/
	refund(id, params, options) {
		return this._makeRequest("POST", `/v1/test_helpers/issuing/transactions/${encodeURIComponent(id)}/refund`, params, options, { responseSchema: {
			kind: "object",
			fields: { purchase_details: {
				kind: "nullable",
				inner: {
...
//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/resources/Treasury/Transactions.js
var TransactionResource = class extends StripeResource {
	...
	*/
	retrieve(id, params, options) {
		return this._makeRequest("GET", `/v1/treasury/transactions/${encodeURIComponent(id)}`, params, options, { responseSchema: {
			kind: "object",
			fields: { entries: {
				kind: "nullable",
				inner: {
...
//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/resources/Radar/ValueListItems.js
...
//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/resources/Radar/ValueLists.js
...
//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/resources/Identity/VerificationReports.js
...
//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/resources/Identity/VerificationSessions.js
...
//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/resources/Accounts.js
var AccountResource = class extends StripeResource {
	...
	*/
	listCapabilities(id, params, options) {
		return this._makeRequest("GET", `/v1/accounts/${encodeURIComponent(id)}/capabilities`, params, options, { methodType: "list" });
	}
	/**
	...
	*/
	listExternalAccounts(id, params, options) {
		return this._makeRequest("GET", `/v1/accounts/${encodeURIComponent(id)}/external_accounts`, params, options, { methodType: "list" });
	}
	/**
	...
	*/
	listPersons(id, params, options) {
		return this._makeRequest("GET", `/v1/accounts/${encodeURIComponent(id)}/persons`, params, options, { methodType: "list" });
	}
	/**
...
//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/resources/AccountLinks.js
...
//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/resources/AccountSessions.js
...
//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/resources/ApplePayDomains.js
...
//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/resources/ApplicationFees.js
var ApplicationFeeResource = class extends StripeResource {
	...
	*/
	listRefunds(id, params, options) {
		return this._makeRequest("GET", `/v1/application_fees/${encodeURIComponent(id)}/refunds`, params, options, { methodType: "list" });
	}
	/**
...
//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/resources/Balance.js
...
//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/resources/BalanceSettings.js
...
//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/resources/BalanceTransactions.js
...
//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/resources/Charges.js
...
//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/resources/ConfirmationTokens.js
...
//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/resources/CountrySpecs.js
...
//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/resources/Coupons.js
...
//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/resources/CreditNotes.js
var CreditNoteResource = class extends StripeResource {
	...
	*/
	retrieve(id, params, options) {
		return this._makeRequest("GET", `/v1/credit_notes/${encodeURIComponent(id)}`, params, options, { responseSchema: {
			kind: "object",
			fields: { lines: {
				kind: "object",
				fields: { data: {
	...
	*/
	update(id, params, options) {
		return this._makeRequest("POST", `/v1/credit_notes/${encodeURIComponent(id)}`, params, options, { responseSchema: {
			kind: "object",
			fields: { lines: {
				kind: "object",
				fields: { data: {
	...
	*/
	voidCreditNote(id, params, options) {
		return this._makeRequest("POST", `/v1/credit_notes/${encodeURIComponent(id)}/void`, params, options, { responseSchema: {
			kind: "object",
			fields: { lines: {
				kind: "object",
				fields: { data: {
...
//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/resources/Customers.js
var CustomerResource = class extends StripeResource {
	...
	*/
	update(id, params, options) {
		return this._makeRequest("POST", `/v1/customers/${encodeURIComponent(id)}`, params, options, { responseSchema: {
			kind: "object",
	...
	*/
	listBalanceTransactions(id, params, options) {
		return this._makeRequest("GET", `/v1/customers/${encodeURIComponent(id)}/balance_transactions`, params, options, { methodType: "list" });
	}
	/**
	...
	*/
	listCashBalanceTransactions(id, params, options) {
		return this._makeRequest("GET", `/v1/customers/${encodeURIComponent(id)}/cash_balance_transactions`, params, options, { methodType: "list" });
	}
	/**
	...
	*/
	listPaymentMethods(id, params, options) {
		return this._makeRequest("GET", `/v1/customers/${encodeURIComponent(id)}/payment_methods`, params, options, { methodType: "list" });
	}
	/**
	...
	*/
	listSources(id, params, options) {
		return this._makeRequest("GET", `/v1/customers/${encodeURIComponent(id)}/sources`, params, options, { methodType: "list" });
	}
	/**
	...
	*/
	listTaxIds(id, params, options) {
		return this._makeRequest("GET", `/v1/customers/${encodeURIComponent(id)}/tax_ids`, params, options, { methodType: "list" });
	}
	/**
...
//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/resources/CustomerSessions.js
...
//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/resources/Disputes.js
...
//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/resources/EphemeralKeys.js
var EphemeralKeyResource = class extends StripeResource {
	...
	*/
	...
	create(params, options) {
		return this._makeRequest("POST", "/v1/ephemeral_keys", params, options, { validator: (data, options$1) => {
			if (!options$1.headers || !options$1.headers["Stripe-Version"]) throw new Error("Passing apiVersion in a separate options hash is required to create an ephemeral key. See https://stripe.com/docs/api/versioning?lang=node");
		} });
	}
};

//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/resources/Events.js
...
//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/resources/ExchangeRates.js
...
//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/multipart.js
...
//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/resources/Files.js
...
//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/resources/FileLinks.js
...
//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/resources/Invoices.js
var InvoiceResource = class extends StripeResource {
	...
	*/
	retrieve(id, params, options) {
		return this._makeRequest("GET", `/v1/invoices/${encodeURIComponent(id)}`, params, options, { responseSchema: {
			kind: "object",
			fields: { lines: {
				kind: "object",
				fields: { data: {
	...
	*/
	update(id, params, options) {
		return this._makeRequest("POST", `/v1/invoices/${encodeURIComponent(id)}`, params, options, { responseSchema: {
			kind: "object",
			fields: { lines: {
				kind: "object",
				fields: { data: {
	...
	*/
	attachPayment(id, params, options) {
		return this._makeRequest("POST", `/v1/invoices/${encodeURIComponent(id)}/attach_payment`, params, options, { responseSchema: {
			kind: "object",
			fields: { lines: {
				kind: "object",
				fields: { data: {
	...
	*/
	finalizeInvoice(id, params, options) {
		return this._makeRequest("POST", `/v1/invoices/${encodeURIComponent(id)}/finalize`, params, options, { responseSchema: {
			kind: "object",
			fields: { lines: {
				kind: "object",
				fields: { data: {
	...
	*/
	markUncollectible(id, params, options) {
		return this._makeRequest("POST", `/v1/invoices/${encodeURIComponent(id)}/mark_uncollectible`, params, options, { responseSchema: {
			kind: "object",
			fields: { lines: {
				kind: "object",
				fields: { data: {
	...
	*/
	pay(id, params, options) {
		return this._makeRequest("POST", `/v1/invoices/${encodeURIComponent(id)}/pay`, params, options, { responseSchema: {
			kind: "object",
			fields: { lines: {
				kind: "object",
				fields: { data: {
	...
	*/
	removeLines(id, params, options) {
		return this._makeRequest("POST", `/v1/invoices/${encodeURIComponent(id)}/remove_lines`, params, options, { responseSchema: {
			kind: "object",
			fields: { lines: {
				kind: "object",
				fields: { data: {
	...
	*/
	sendInvoice(id, params, options) {
		return this._makeRequest("POST", `/v1/invoices/${encodeURIComponent(id)}/send`, params, options, { responseSchema: {
			kind: "object",
			fields: { lines: {
				kind: "object",
				fields: { data: {
	...
	*/
	voidInvoice(id, params, options) {
		return this._makeRequest("POST", `/v1/invoices/${encodeURIComponent(id)}/void`, params, options, { responseSchema: {
			kind: "object",
			fields: { lines: {
				kind: "object",
				fields: { data: {
...
//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/resources/InvoiceItems.js
var InvoiceItemResource = class extends StripeResource {
	...
	*/
	retrieve(id, params, options) {
		return this._makeRequest("GET", `/v1/invoiceitems/${encodeURIComponent(id)}`, params, options, { responseSchema: {
			kind: "object",
			fields: {
				pricing: {
					kind: "nullable",
...
//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/resources/InvoicePayments.js
...
//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/resources/InvoiceRenderingTemplates.js
...
//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/resources/Mandates.js
...
//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/resources/OAuth.js
...
//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/resources/PaymentAttemptRecords.js
...
//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/resources/PaymentIntents.js
var PaymentIntentResource = class extends StripeResource {
	...
	*/
	listAmountDetailsLineItems(id, params, options) {
		return this._makeRequest("GET", `/v1/payment_intents/${encodeURIComponent(id)}/amount_details_line_items`, params, options, { methodType: "list" });
	}
};

//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/resources/PaymentLinks.js
var PaymentLinkResource = class extends StripeResource {
	...
	*/
	retrieve(id, params, options) {
		return this._makeRequest("GET", `/v1/payment_links/${encodeURIComponent(id)}`, params, options, { responseSchema: {
			kind: "object",
			fields: { line_items: {
				kind: "object",
				fields: { data: {
	...
	*/
	update(id, params, options) {
		return this._makeRequest("POST", `/v1/payment_links/${encodeURIComponent(id)}`, params, options, { responseSchema: {
			kind: "object",
			fields: { line_items: {
				kind: "object",
				fields: { data: {
...
//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/resources/PaymentMethods.js
...
//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/resources/PaymentMethodConfigurations.js
...
//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/resources/PaymentMethodDomains.js
...
//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/resources/PaymentRecords.js
...
//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/resources/Payouts.js
...
//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/resources/Plans.js
var PlanResource = class extends StripeResource {
	...
	*/
	retrieve(id, params, options) {
		return this._makeRequest("GET", `/v1/plans/${encodeURIComponent(id)}`, params, options, { responseSchema: {
			kind: "object",
			fields: {
				amount_decimal: {
					kind: "nullable",
	...
	*/
	update(id, params, options) {
		return this._makeRequest("POST", `/v1/plans/${encodeURIComponent(id)}`, params, options, { responseSchema: {
			kind: "object",
			fields: {
				amount_decimal: {
					kind: "nullable",
...
//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/resources/Prices.js
var PriceResource = class extends StripeResource {
	...
	*/
	retrieve(id, params, options) {
		return this._makeRequest("GET", `/v1/prices/${encodeURIComponent(id)}`, params, options, { responseSchema: {
			kind: "object",
			fields: {
				currency_options: {
					kind: "array",
	...
	*/
	update(id, params, options) {
		return this._makeRequest("POST", `/v1/prices/${encodeURIComponent(id)}`, params, options, { responseSchema: {
			kind: "object",
			fields: {
				currency_options: {
					kind: "array",
...
//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/resources/Products.js
var ProductResource = class extends StripeResource {
	...
	*/
	listFeatures(id, params, options) {
		return this._makeRequest("GET", `/v1/products/${encodeURIComponent(id)}/features`, params, options, { methodType: "list" });
	}
	/**
...
//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/resources/PromotionCodes.js
...
//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/resources/Quotes.js
var QuoteResource = class extends StripeResource {
	...
	*/
	retrieve(id, params, options) {
		return this._makeRequest("GET", `/v1/quotes/${encodeURIComponent(id)}`, params, options, { responseSchema: {
			kind: "object",
			fields: { computed: {
				kind: "object",
				fields: { upfront: {
	...
	*/
	accept(id, params, options) {
		return this._makeRequest("POST", `/v1/quotes/${encodeURIComponent(id)}/accept`, params, options, { responseSchema: {
			kind: "object",
			fields: { computed: {
				kind: "object",
				fields: { upfront: {
	...
	*/
	cancel(id, params, options) {
		return this._makeRequest("POST", `/v1/quotes/${encodeURIComponent(id)}/cancel`, params, options, { responseSchema: {
			kind: "object",
			fields: { computed: {
				kind: "object",
				fields: { upfront: {
	...
	*/
	finalizeQuote(id, params, options) {
		return this._makeRequest("POST", `/v1/quotes/${encodeURIComponent(id)}/finalize`, params, options, { responseSchema: {
			kind: "object",
			fields: { computed: {
				kind: "object",
				fields: { upfront: {
...
//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/resources/Refunds.js
...
//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/resources/Reviews.js
...
//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/resources/SetupAttempts.js
...
//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/resources/SetupIntents.js
...
//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/resources/ShippingRates.js
...
//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/resources/Sources.js
var SourceResource = class extends StripeResource {
	...
	*/
	listSourceTransactions(id, params, options) {
		return this._makeRequest("GET", `/v1/sources/${encodeURIComponent(id)}/source_transactions`, params, options, { methodType: "list" });
	}
};

//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/resources/Subscriptions.js
var SubscriptionResource = class extends StripeResource {
	...
	*/
	cancel(id, params, options) {
		return this._makeRequest("DELETE", `/v1/subscriptions/${encodeURIComponent(id)}`, params, options, { responseSchema: {
			kind: "object",
			fields: { items: {
				kind: "object",
				fields: { data: {
	...
	*/
	retrieve(id, params, options) {
		return this._makeRequest("GET", `/v1/subscriptions/${encodeURIComponent(id)}`, params, options, { responseSchema: {
			kind: "object",
			fields: { items: {
				kind: "object",
				fields: { data: {
	...
	*/
	migrate(id, params, options) {
		return this._makeRequest("POST", `/v1/subscriptions/${encodeURIComponent(id)}/migrate`, params, options, { responseSchema: {
			kind: "object",
			fields: { items: {
				kind: "object",
				fields: { data: {
	...
	*/
	resume(id, params, options) {
		return this._makeRequest("POST", `/v1/subscriptions/${encodeURIComponent(id)}/resume`, params, options, { responseSchema: {
			kind: "object",
			fields: { items: {
				kind: "object",
				fields: { data: {
...
//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/resources/SubscriptionItems.js
var SubscriptionItemResource = class extends StripeResource {
	...
	*/
	retrieve(id, params, options) {
		return this._makeRequest("GET", `/v1/subscription_items/${encodeURIComponent(id)}`, params, options, { responseSchema: {
			kind: "object",
			fields: {
				plan: {
					kind: "object",
...
//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/resources/SubscriptionSchedules.js
var SubscriptionScheduleResource = class extends StripeResource {
	...
	*/
	update(id, params, options) {
		return this._makeRequest("POST", `/v1/subscription_schedules/${encodeURIComponent(id)}`, params, options, { requestSchema: {
			kind: "object",
			fields: { phases: {
				kind: "array",
				element: {
...
//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/resources/TaxCodes.js
...
//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/resources/TaxIds.js
...
//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/resources/TaxRates.js
...
//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/resources/Tokens.js
...
//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/resources/Topups.js
...
//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/resources/Transfers.js
var TransferResource = class extends StripeResource {
	...
	*/
	listReversals(id, params, options) {
		return this._makeRequest("GET", `/v1/transfers/${encodeURIComponent(id)}/reversals`, params, options, { methodType: "list" });
	}
	/**
...
//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/resources/WebhookEndpoints.js
...
//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/resources.js
var resources_exports = /* @__PURE__ */ __export({
...
const Checkout$1 = resourceNamespace("checkout", { Sessions: SessionResource$1 });
...
const Forwarding$1 = resourceNamespace("forwarding", { Requests: RequestResource });
...
const Sigma$1 = resourceNamespace("sigma", { ScheduledQueryRuns: ScheduledQueryRunResource });
...
const V2$1 = resourceNamespace("v2", {
	...
	Commerce: resourceNamespace("commerce", { ProductCatalog: resourceNamespace("productCatalog", { Imports: ImportResource }) }),
...
//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/resources/Apps/index.js
var Apps = class {
	constructor(stripe) {
		this.stripe = stripe;
...
//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/resources/Billing/index.js
var Billing = class {
	constructor(stripe) {
		this.stripe = stripe;
...
//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/resources/BillingPortal/index.js
...
//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/resources/Checkout/index.js
var Checkout = class {
	constructor(stripe) {
		this.stripe = stripe;
...
//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/resources/Climate/index.js
var Climate = class {
	constructor(stripe) {
		this.stripe = stripe;
...
//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/resources/Entitlements/index.js
...
//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/resources/FinancialConnections/index.js
...
//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/resources/Forwarding/index.js
...
//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/resources/Identity/index.js
var Identity = class {
	constructor(stripe) {
		this.stripe = stripe;
...
//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/resources/Issuing/index.js
var Issuing = class {
	constructor(stripe) {
		this.stripe = stripe;
...
//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/resources/Radar/index.js
var Radar = class {
	constructor(stripe) {
		this.stripe = stripe;
...
//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/resources/Reporting/index.js
var Reporting = class {
	constructor(stripe) {
		this.stripe = stripe;
...
//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/resources/Sigma/index.js
var Sigma = class {
	constructor(stripe) {
		this.stripe = stripe;
...
//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/resources/Tax/index.js
var Tax = class {
	constructor(stripe) {
		this.stripe = stripe;
...
//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/resources/Terminal/index.js
var Terminal = class {
	constructor(stripe) {
		this.stripe = stripe;
...
//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/resources/TestHelpers/Issuing/index.js
var Issuing$1 = class {
	constructor(stripe) {
		this.stripe = stripe;
...
//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/resources/TestHelpers/Terminal/index.js
...
//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/resources/TestHelpers/Treasury/index.js
...
//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/resources/TestHelpers/index.js
var TestHelpers = class {
	constructor(stripe) {
		...
		this.issuing = new Issuing$1(stripe);
		this.terminal = new Terminal$1(stripe);
		this.treasury = new Treasury$1(stripe);
	}
};

//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/resources/Treasury/index.js
var Treasury = class {
	constructor(stripe) {
		this.stripe = stripe;
...
//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/resources/V2/Billing/index.js
var Billing$1 = class {
	constructor(stripe) {
		this.stripe = stripe;
...
//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/resources/V2/Commerce/ProductCatalog/index.js
...
//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/resources/V2/Commerce/index.js
var Commerce = class {
	constructor(stripe) {
		this.stripe = stripe;
...
//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/resources/V2/Core/index.js
var Core = class {
	constructor(stripe) {
		this.stripe = stripe;
...
//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/resources/V2/index.js
var V2 = class {
	constructor(stripe) {
		this.stripe = stripe;
		this.billing = new Billing$1(stripe);
...
//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/stripe.core.js
...
var Stripe = class Stripe {
	...
	*/
	getClientUserAgentSeeded(seed, cb) {
		...
		if (Stripe.SOURCE_HASH) userAgent.source = Stripe.SOURCE_HASH;
...
//#endregion
//#region node_modules/.pnpm/stripe@22.2.1_@types+node@24.2.1/node_modules/stripe/esm/stripe.esm.worker.js
Stripe.initialize(new WebPlatformFunctions());
var stripe_esm_worker_default = Stripe;

//#endregion
export { Decimal, Stripe, stripe_esm_worker_default as default };
