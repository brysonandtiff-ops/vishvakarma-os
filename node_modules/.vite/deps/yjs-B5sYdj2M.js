...
const setIfUndefined = (map$2, key, createT) => {
	let set = map$2.get(key);
	if (set === void 0) map$2.set(key, set = createT());
	return set;
};
/**
...
//#endregion
//#region node_modules/.pnpm/lib0@0.2.117/node_modules/lib0/webcrypto.js
...
/* c8 ignore next 2 */
var forceColor = isNode && isOneOf(process.env.FORCE_COLOR, [
	"true",
	"1",
	"2"
]);
...
* @param {number} length
*/
const createUint8ArrayViewFromArrayBuffer = (buffer, byteOffset, length$1) => new Uint8Array(buffer, byteOffset, length$1);
/**
* Create Uint8Array with initial content from buffer
*
* @param {ArrayBuffer} buffer
...
*/
const int53 = (gen, min$1, max$1) => floor(gen.next() * (max$1 + 1 - min$1) + min$1);
/**
...
* @return {Number} A random integer on [min, max]
*/
const int32 = (gen, min$1, max$1) => floor(gen.next() * (max$1 + 1 - min$1) + min$1);
/**
* @deprecated
...
* @return {Number} A random integer on [min, max]
*/
const int31 = (gen, min$1, max$1) => int32(gen, min$1, max$1);
/**
* @param {PRNG} gen
...
* @function
*/
var writeStateAsUpdate = (encoder, doc$1, targetStateVector = /* @__PURE__ */ new Map()) => {
...
* @function
*/
var encodeStateAsUpdateV2 = (doc$1, encodedTargetStateVector = new Uint8Array([0]), encoder = new UpdateEncoderV2()) => {
...
* @function
*/
var encodeStateAsUpdate = (doc$1, encodedTargetStateVector) => encodeStateAsUpdateV2(doc$1, encodedTargetStateVector, new UpdateEncoderV1());
/**
...
* @function
*/
var writeDocumentStateVector = (encoder, doc$1) => writeStateVector(encoder, getStateVector(doc$1.store));
/**
...
* @function
*/
var encodeStateVectorV2 = (doc$1, encoder = new DSEncoderV2()) => {
...
* @function
*/
var encodeStateVector = (doc$1) => encodeStateVectorV2(doc$1, new DSEncoderV1());
/**
...
* @function
*/
var writeID = (encoder, id$1) => {
	writeVarUint(encoder, id$1.client);
	writeVarUint(encoder, id$1.clock);
};
/**
* Read ID.
...
* @param {ID} id
*/
var getItemWithOffset = (store, id$1) => {
...
* @return {Uint8Array}
*/
var encodeSnapshotV2 = (snapshot$1, encoder = new DSEncoderV2()) => {
	writeDeleteSet(encoder, snapshot$1.ds);
	writeStateVector(encoder, snapshot$1.sv);
	return encoder.toUint8Array();
};
/**
* @param {Snapshot} snapshot
* @return {Uint8Array}
*/
var encodeSnapshot = (snapshot$1) => encodeSnapshotV2(snapshot$1, new DSEncoderV1());
/**
* @param {Uint8Array} buf
* @param {DSDecoderV1 | DSDecoderV2} [decoder]
* @return {Snapshot}
...
* @function
*/
var isVisible = (item, snapshot$1) => snapshot$1 === void 0 ? !item.deleted : snapshot$1.sv.has(item.id.client) && (snapshot$1.sv.get(item.id.client) || 0) > item.id.clock && !isDeleted(snapshot$1.ds, item.id);
/**
* @param {Transaction} transaction
* @param {Snapshot} snapshot
*/
...
* @return {Doc}
*/
var createDocFromSnapshot = (originDoc, snapshot$1, newDoc = new Doc()) => {
	if (originDoc.gc) throw new Error("Garbage-collection must be disabled in `originDoc`!");
	const { sv, ds } = snapshot$1;
	const encoder = new UpdateEncoderV2();
	originDoc.transact((transaction) => {
		...
		writeVarUint(encoder.restEncoder, size$1);
...
*/
var snapshotContainsUpdateV2 = (snapshot$1, update, YDecoder = UpdateDecoderV2) => {
	const updateDecoder = new YDecoder(createDecoder(update));
	const lazyDecoder = new LazyStructReader(updateDecoder, false);
	for (let curr = lazyDecoder.curr; curr !== null; curr = lazyDecoder.next()) if ((snapshot$1.sv.get(curr.id.client) || 0) < curr.id.clock + curr.length) return false;
	const mergedDS = mergeDeleteSets([snapshot$1.ds, readDeleteSet(updateDecoder)]);
	return equalDeleteSets(snapshot$1.ds, mergedDS);
};
/**
* @param {Snapshot} snapshot
* @param {Uint8Array} update
*/
var snapshotContainsUpdate = (snapshot$1, update) => snapshotContainsUpdateV2(snapshot$1, update, UpdateDecoderV1);
...
* @function
*/
var getItemCleanStart = (transaction, id$1) => {
...
* @function
*/
var getItemCleanEnd = (transaction, store, id$1) => {
	/**
	* @type {Array<Item>}
	*/
	const structs = store.clients.get(id$1.client);
...
var parseUpdateMetaV2 = (update, YDecoder = UpdateDecoderV2) => {
	...
	*/
	...
	if (curr !== null) {
		...
		from$1.set(currClient, currClock);
		for (; curr !== null; curr = updateDecoder.next()) {
			if (currClient !== curr.id.client) {
				to.set(currClient, currClock);
				from$1.set(curr.id.client, curr.id.clock);
				currClient = curr.id.client;
			}
...
* @function
*/
var typeMapGetSnapshot = (parent, key, snapshot$1) => {
	let v = parent._map.get(key) || null;
	while (v !== null && (!snapshot$1.sv.has(v.id.client) || v.id.clock >= (snapshot$1.sv.get(v.id.client) || 0))) v = v.left;
	return v !== null && isVisible(v, snapshot$1) ? v.content.getContent()[v.length - 1] : void 0;
};
/**
* @param {AbstractType<any>} parent
* @param {Snapshot} snapshot
...
var YArray = class YArray extends AbstractType {
 ...
 /** @type {Array<any>} */ this._prelimContent.splice(index, length$1);
	}
	/**
...
var YText = class YText extends AbstractType {
 ...
 /** @type {Array<function>} */ this._pending.push(() => this.delete(index, length$1));
	}
	/**
 ...
 /** @type {Array<function>} */ this._pending.push(() => this.format(index, length$1, attributes));
	}
	/**
...
* @param {ID} id
*/
var isDeletedByUndoStack = (stack, id$1) => some(
	stack,
	/** @param {StackItem} s */
...
//#endregion
export { createRelativePositionFromTypeIndex as $, isNode as $t, YEvent as A, logType as At, applyUpdate as B, readUpdate as Bt, UndoManager as C, getItemCleanEnd as Ct, UpdateEncoderV2 as D, isDeleted as Dt, UpdateEncoderV1 as E, getTypeChildren as Et, YXmlElement as F, mergeUpdatesV2 as Ft, convertUpdateFormatV1ToV2 as G, transact as Gt, cleanupYTextFormatting as H, relativePositionToJSON as Ht, YXmlEvent as I, obfuscateUpdate as It, createDeleteSet as J, typeMapGetAllSnapshot as Jt, convertUpdateFormatV2ToV1 as K, tryGc as Kt, YXmlFragment as L, obfuscateUpdateV2 as Lt, YMapEvent as M, logUpdateV2 as Mt, YText as N, mergeDeleteSets as Nt, YArray as O, isParentOf as Ot, YTextEvent as P, mergeUpdates as Pt, createRelativePositionFromJSON as Q, toBase64 as Qt, YXmlHook as R, parseUpdateMeta as Rt, Transaction as S, setIfUndefined as Sn, getItem as St, UpdateDecoderV2 as T, getState as Tt, compareIDs as U, snapshot as Ut, applyUpdateV2 as V, readUpdateV2 as Vt, compareRelativePositions as W, snapshotContainsUpdate as Wt, createDocFromSnapshot as X, createUint8ArrayFromArrayBuffer as Xt, createDeleteSetFromStructStore as Y, typeMapGetSnapshot as Yt, createID as Z, fromBase64 as Zt, Item as _, min as _n, encodeStateVectorFromUpdateV2 as _t, ContentAny as a, getUnixTime as an, decodeUpdate as at, Skip as b, ObservableV2 as bn, findIndexSS as bt, ContentDoc as c, readVarUint as cn, diffUpdateV2 as ct, ContentJSON as d, length as dn, encodeSnapshot as dt, equalityDeep as en, createSnapshot as et, ContentString as f, toUint8Array as fn, encodeSnapshotV2 as ft, ID as g, floor as gn, encodeStateVectorFromUpdate as gt, GC as h, writeVarUint8Array as hn, encodeStateVector as ht, AbstractType as i, varStorage as in, decodeStateVector as it, YMap as j, logUpdate as jt, YArrayEvent as k, iterateDeletedStructs as kt, ContentEmbed as l, readVarUint8Array as ln, emptySnapshot as lt, Doc as m, writeVarUint as mn, encodeStateAsUpdateV2 as mt, AbstractConnector as n, offChange as nn, decodeSnapshot as nt, ContentBinary as o, createDecoder as on, decodeUpdateV2 as ot, ContentType as p, writeVarString as pn, encodeStateAsUpdate as pt, createAbsolutePositionFromRelativePosition as q, typeListToArraySnapshot as qt, AbstractStruct as r, onChange as rn, decodeSnapshotV2 as rt, ContentDeleted as s, readVarString as sn, diffUpdate as st, AbsolutePosition as t, map as tn, decodeRelativePosition as tt, ContentFormat as u, createEncoder as un, encodeRelativePosition as ut, PermanentUserData as v, pow as vn, equalDeleteSets as vt, UpdateDecoderV1 as w, getItemCleanStart as wt, Snapshot as x, create$4 as xn, findRootTypeKey as xt, RelativePosition as y, Observable as yn, equalSnapshots as yt, YXmlText as z, parseUpdateMetaV2 as zt };
//# sourceMappingURL=yjs-B5sYdj2M.js.map