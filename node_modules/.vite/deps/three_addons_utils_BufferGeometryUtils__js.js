import { $n as InterleavedBuffer, Ds as Vector3, Gn as InstancedBufferAttribute, K as BufferAttribute, _n as Float32BufferAttribute, as as TriangleFanDrawMode, er as InterleavedBufferAttribute, os as TriangleStripDrawMode, q as BufferGeometry, ss as TrianglesDrawMode } from "./three.module-BC2mUsB1.js";
...
function mergeVertices(geometry, tolerance = 1e-4) {
	...
	for (let i = 0, l = attributeNames.length; i < l; i++) {
		...
		if (morphAttributes) {
			...
			morphAttributes.forEach((morphAttr, i$1) => {
				const array = new morphAttr.array.constructor(morphAttr.count * morphAttr.itemSize);
				tmpMorphAttributes[name][i$1] = new morphAttr.constructor(array, morphAttr.itemSize, morphAttr.normalized);
			});
		}
	}
...
function computeMorphedAttributes(object) {
	...
	function _calculateMorphedAttributeData(object$1, attribute, morphAttribute, morphTargetsRelative$1, a$1, b$1, c$1, modifiedAttributeArray) {
		_vA.fromBufferAttribute(attribute, a$1);
		_vB.fromBufferAttribute(attribute, b$1);
		_vC.fromBufferAttribute(attribute, c$1);
		const morphInfluences = object$1.morphTargetInfluences;
		if (morphAttribute && morphInfluences) {
			_morphA.set(0, 0, 0);
			_morphB.set(0, 0, 0);
			_morphC.set(0, 0, 0);
			for (let i$1 = 0, il$1 = morphAttribute.length; i$1 < il$1; i$1++) {
				const influence = morphInfluences[i$1];
				const morph = morphAttribute[i$1];
				if (influence === 0) continue;
				_tempA.fromBufferAttribute(morph, a$1);
				_tempB.fromBufferAttribute(morph, b$1);
				_tempC.fromBufferAttribute(morph, c$1);
				if (morphTargetsRelative$1) {
		...
		if (object$1.isSkinnedMesh) {
			object$1.applyBoneTransform(a$1, _vA);
			object$1.applyBoneTransform(b$1, _vB);
			object$1.applyBoneTransform(c$1, _vC);
		}
		modifiedAttributeArray[a$1 * 3 + 0] = _vA.x;
		modifiedAttributeArray[a$1 * 3 + 1] = _vA.y;
		modifiedAttributeArray[a$1 * 3 + 2] = _vA.z;
		modifiedAttributeArray[b$1 * 3 + 0] = _vB.x;
		modifiedAttributeArray[b$1 * 3 + 1] = _vB.y;
		modifiedAttributeArray[b$1 * 3 + 2] = _vB.z;
		modifiedAttributeArray[c$1 * 3 + 0] = _vC.x;
		modifiedAttributeArray[c$1 * 3 + 1] = _vC.y;
		modifiedAttributeArray[c$1 * 3 + 2] = _vC.z;
	}
